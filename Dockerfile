...
RUN alias cmlamd='cmake -DBUILD_TESTING=OFF -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_CUDA_FLAGS="-g -G --ptxas-options=-v" -DCMAKE_CXX_FLAGS="-g -pg" -DCMAKE_EXE_LINKER_FLAGS="-g -pg" -DCMAKE_BUILD_TYPE=Debug .. && cmake --build .'
