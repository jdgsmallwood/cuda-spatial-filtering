...
// This translation unit is the ONLY place that includes casacore's measures
// headers and instantiates its templates. It is compiled by the system C++
// compiler (CMAKE_CXX_COMPILER, /usr/bin/g++) as part of libspatial -- see
// the comment block in pointing.hpp and the casacore wiring in
// src/CMakeLists.txt for why this split exists (nvcc/conda-gcc resolve
// <casacore/...> to an ABI-incompatible header copy under /opt/conda/include,
// while the project links the system casacore libraries built against
// /usr/include).
