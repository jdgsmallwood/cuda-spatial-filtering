...
//                     nr_packets_for_correlation, const int nr_times_per_block,
...
//   *>(packet); uint16_t ethertype = ntohs(eth->ethertype); if (ethertype !=
//   0x0800) {
...
//   const int sample_frame_to_populate = packet_num /
//   nr_packets_for_correlation; const int num_blocks_per_packet =
...
//          packet_num_in_frame * num_blocks_per_packet,
